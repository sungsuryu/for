...
<script>
	...
	function goBoardView(board_idx){
		...
		location.href = "/board/pdsView.do?board_idx=" + board_idx;
	}
		...
		<ul>
			...
			<li class="depth1 on">
				...
				<ul>
					<li class="depth2"><a href="for_020.htm">FAQ</a></li>
					<li class="depth2"><a href="for_021.htm">공지사항</a></li>
					<li class="depth2 on"><a href="for_022.htm">보고관련 자료실</a></li>
				</ul>				
			</li>
			<li class="depth1">
...
<div id="contents">
		...
		<div class="navi">
			...
			<span class="styled_select">
				<select>
					<option>공지사항</option>
					<option>FAQ</option>
					<option selected>보고관련 자료실</option>
				</select>
				<i class="fa fa-chevron-down" aria-hidden="true"></i>
			</span>
		</div>
	...
	<div class="top_search_area">
		<form id="searchForm" name="searchForm" method="post" action="/board/pds.do">
